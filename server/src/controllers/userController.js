...
const verifyNewEmail = asyncHandler(
  async (req, res) => {
    const {
      otp,
    } = req.body;
...
const changePhone = asyncHandler(
  async (req, res) => {
    const {
      newPhone,
    } = req.body;
    ...
    if (user.phone === phone) {
      throw new ApiError(
        400,
        "New phone cannot be same as current phone"
      );
    }
...
const verifyNewPhone = asyncHandler(
  async (req, res) => {
    const {
      otp,
    } = req.body;
