...
const productVariantSchema = new mongoose.Schema(
    {
        ...
        sku: {
            ...
            minlength: [
                2,
                "Variant SKU must be at least 2 characters",
            ],
            maxlength: [
                100,
                "Variant SKU cannot exceed 100 characters",
            ],
        },
        ...
        size: {
            ...
            maxlength: [
                50,
                "Size cannot exceed 50 characters",
            ],
            default: "",
        },
        ...
        image: {
            ...
            maxlength: [
                1000,
                "Variant image URL cannot exceed 1000 characters",
            ],
            default: "",
        },
...
productSchema.pre("validate", function (next) {
    ...
    if (
        ...
        if (
            ...
            return next(
                new Error(
                    "Final price does not match base price and discount"
                )
            );
        }
    }
